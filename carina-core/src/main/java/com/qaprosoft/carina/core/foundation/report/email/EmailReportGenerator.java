...
/**
 * EmailReportGenerator generates emailable report using data from test suite
 * log.
 * 
...
public class EmailReportGenerator {
    ...
    public EmailReportGenerator(String title, String url, String version, String device, String browser, String finishDate, String elapsedTime,
            String ciTestJob, List<TestResultItem> testResultItems, List<String> createdItems) {
    ...
    public static TestResultType getSuiteResult(List<TestResultItem> ris) {
        ...
        if (passed == 0 && failed == 0 && skipped == 0 && skipped_already_passed > 0) {
            result = TestResultType.SKIP_ALL_ALREADY_PASSED; // it was re-run of
                                                             // the suite where
                                                             // all tests passed
                                                             // during previous
                                                             // run
