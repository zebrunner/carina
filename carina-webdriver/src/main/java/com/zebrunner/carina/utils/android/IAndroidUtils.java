...
public interface IAndroidUtils extends IMobileUtils {
     ...
     * @param type permission type. See {@link Permissions.PermissionType}
     * @return ArrayList String
     * @throws UnsupportedOperationException if driver does not support this feature
     */
    @SuppressWarnings("unchecked")
    default public List<String> getAppPermissions(String appPackage, Permissions.PermissionType type) {
     ...
     * @param action permission action, see {@link Permissions.PermissionAction}
     * @param permissions list of permissions {@link Permissions.Permission}
     * @throws UnsupportedOperationException if driver does not support this feature
     */
    default public void changePermissions(String packageName, Permissions.PermissionAction action, Permissions.Permission... permissions) {
        List<String> permissionsStr = Arrays.stream(permissions)
                .map(Permissions.Permission::getPermission)
