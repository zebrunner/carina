...
public class AndroidService implements IDriverPool, IAndroidUtils {
    ...
    public DeviceTimeZone getDeviceTimeZone(String defaultTZ) {
        ...
        if (value.contains("12")) {
            dt.setTimeFormat(DeviceTimeZone.TimeFormat.FORMAT_12);
        } else {
            dt.setTimeFormat(DeviceTimeZone.TimeFormat.FORMAT_24);
        }
     ...
     * @return boolean
     */
    public boolean setDeviceTimeZone(String timeZone, DeviceTimeZone.TimeFormat timeFormat) {
     ...
     * @return boolean
     */
    public boolean setDeviceTimeZone(String timeZone, String settingsTZ, DeviceTimeZone.TimeFormat timeFormat) {
     ...
     * @return boolean
     */
    public boolean setDeviceTimeZone(String timeZone, String settingsTZ, DeviceTimeZone.TimeFormat timeFormat, String gmtStamp, ChangeTimeZoneWorkflow workflow) {
     ...
     * @return String
     */
    private String setDeviceTimeZoneByADB(String timeZone, DeviceTimeZone.TimeFormat timeFormat, String deviceSetDate) {
     ...
     * @param gmtStamp String
     */
    private void setDeviceTimeZoneBySetting(String timeZone, String settingsTZ, DeviceTimeZone.TimeFormat timeFormat, String gmtStamp) {
     ...
     * @param timeFormat TimeFormat
     */
    private void setDeviceTimeZoneByChangerApk(String timeZone, DeviceTimeZone.TimeFormat timeFormat) {
        String actualTZ = getDeviceActualTimeZone();
     ...
     * @return boolean
     */
    private boolean forceTZChangingApkOpen(boolean turnOffAuto, DeviceTimeZone.TimeFormat timeFormat) {
        boolean res = false;
     ...
     */
    private void openDateTimeSettingsSetupWizard(boolean turnOffAuto, DeviceTimeZone.TimeFormat timeFormat) {
        if (turnOffAuto) {
     ...
     * @param timeFormat - can be 12 or 24. Or empty.
     */
    private void openTZChangingApk(boolean turnOffAuto, DeviceTimeZone.TimeFormat timeFormat) {
        if (turnOffAuto) {
            switchDeviceAutoTimeAndTimeZone(false);
        }
