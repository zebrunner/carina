...
public class FirefoxDesktopFactory extends AbstractBrowserFactory<FirefoxOptions> {
    private static final Logger LOGGER = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

    private static MutableCapabilities staticCapabilities;

    @Override
    public WebDriver create(String name, FirefoxOptions capabilities, String seleniumHost) {
    ...
    public FirefoxOptions getCapabilities(String name) {
