...
public class DriverListener implements WebDriverListener, IDriverPool {
    ...
    // onAfterAction("Alert accepted", currentDriver);
    // }
    ...
    public void afterSendKeys(WebElement element, CharSequence... keysToSend) {
        captureScreenshot(String.format("Text '%s' typed", charArrayToString(keysToSend)), driver, element, false);
    }
    ...
    public void afterClick(WebElement element) {
        captureScreenshot("Element clicked", driver, element, false);
    }
    ...
    // // carina has a lot of extra verifications to solve all stale reference issue and finally perform an action so ignore such exception in
    // listener!
