...
public class BrowserStackAndroidFactory extends AbstractFactory {
    ...
    public WebDriver create(String testName, String seleniumHost, Capabilities capabilities) {
        MutableCapabilities options = new UIAutomator2Capabilities().getCapabilities(testName, capabilities);
