...
public class SafariDesktopFactory extends AbstractDriverFactory<SafariOptions> {
    private static final Logger LOGGER = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

    private static MutableCapabilities staticCapabilities;

    @Override
    public WebDriver create(String name, SafariOptions capabilities, String seleniumHost) {
    ...
    public SafariOptions getCapabilities(String name) {
