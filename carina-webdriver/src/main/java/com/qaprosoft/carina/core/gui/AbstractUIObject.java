...
public abstract class AbstractUIObject extends DriverHelper {
    ...
    /**
     * Initializes UI object using {@link PageFactory}. Whole browser window is
     * used as search context
     * 
    ...
    /**
     * Initializes UI object using {@link PageFactory}. Browser area for
     * internal elements initialization is bordered by SearchContext instance.
     * If {@link WebDriver} object is used as search context then whole browser
     * window will be used for initialization of {@link ExtendedWebElement}
     * fields inside.
     * 
     * Note: implement this constructor if you want your
     * {@link AbstractUIObject} instances marked with {@link FindBy} to be
     * auto-initialized on {@link AbstractPage} inheritors
     * 
     * @param driver WebDriver instance to initialize UI Object fields using
     * PageFactory
     * @param searchContext Window area that will be used for locating of
     * internal elements
     */
     ...
     *
     * If {@link AbstractUIObject} field on {@link AbstractPage} is marked with
     * {@link FindBy} annotation then this locator will be used to instantiate
     * rootElement
     * 
