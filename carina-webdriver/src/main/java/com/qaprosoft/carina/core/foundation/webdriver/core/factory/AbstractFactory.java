 ...
 */
public abstract class AbstractFactory<T extends MutableCapabilities> {
     ...
     */
    abstract public WebDriver create(String testName, T capabilities, String seleniumHost);
