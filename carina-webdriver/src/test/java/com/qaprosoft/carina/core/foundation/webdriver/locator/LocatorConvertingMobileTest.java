...
public class LocatorConvertingMobileTest {
    ...
    private final CaseInsensitiveConverter converter = new CaseInsensitiveConverter(new ParamsToConvert(false, false, false, false), Platform.MOBILE);

    @Test
    public void convertIdToXpathTest() {
        By idLocator = By.id("some_id");
        By expectedRes = By.xpath(
                "//*[ends-with(@resource-id, ':id/some_id')]");
