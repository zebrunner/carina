...
public class MongoConnector {
    ...
    private static void validateConfig(String database) {
        if (StringUtils.isEmpty(host) || SpecialKeywords.MUST_OVERRIDE.equals(host) || StringUtils.isEmpty(port)
                || SpecialKeywords.MUST_OVERRIDE.equals(port) || StringUtils.isEmpty(user) || SpecialKeywords.MUST_OVERRIDE.equals(user)
                || StringUtils.isEmpty(password) || SpecialKeywords.MUST_OVERRIDE.equals(password) || StringUtils.isEmpty(database)
                || SpecialKeywords.MUST_OVERRIDE.equals(database)) {
