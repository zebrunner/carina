...
public class Jira {
    ...
    public static boolean isRetryDisabled(ITestResult result) {
        ...
        // [VD] QUALITY-1408 disable retry test execution if ignore_known_issues
        // is enabled and jira ticket(s) provided
    ...
    public synchronized static String processBug(ITestResult result) {
        if (isInitialized) {
            ...
            if (bugId == null) {
                Map<Object[], String> testnameBugMap = (Map<Object[], String>) result.getTestContext().getAttribute(SpecialKeywords.BUG_ARGS_MAP);
